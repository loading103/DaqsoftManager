package com.daqsoft.module_mine.alone
 ...
 * @describe
 */
class MineAloneActivity : AppCompatActivity() {
    override fun onCreate(@Nullable savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        val intent = Intent(this, ContainerActivity::class.java)
        intent.putExtra(ContainerActivity.FRAGMENT, MineFragment::class.java.canonicalName)
