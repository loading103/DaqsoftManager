...
public class MultipleLayoutManager {
     ...
     * 三种默认布局 ID
     */
    private static final int DEFAULT_LOADING_LAYOUT_ID = R.layout.multiple_layout_loading;
    private static final int DEFAULT_EMPTY_LAYOUT_ID = R.layout.multiple_layout_empty;
    private static final int DEFAULT_ERROR_LAYOUT_ID = R.layout.multiple_layout_error;

    /**
     * 默认布局中可点击的 view ID
     */
    private static final int DEFAULT_EMPTY_CLICKED_ID = R.id.empty_content;
    private static final int DEFAULT_ERROR_CLICKED_ID = R.id.error_content;

    /**
     * 默认颜色
     */
    private static final int DEFAULT_CLICKED_TEXT_COLOR = R.color.multiple_layout_tip_text_color;
    private static final int DEFAULT_BACKGROUND_COLOR = R.color.multiple_layout_background_color;

    /**
     * 默认图片
     */
    private static final int DEFAULT_EMPTY_IMG_ID = R.mipmap.multiple_layout_empty;
    private static final int DEFAULT_ERROR_IMG_ID = R.mipmap.multiple_layout_error;
    ...
    private MultipleLayoutChildClickListener onStatusChildClickListener;

    private MultipleLayoutReplaceHelper replaceLayoutHelper;

    private LayoutInflater inflater;

    private MultipleLayoutManager(Builder builder) {
        ...
        this.replaceLayoutHelper = new MultipleLayoutReplaceHelper(contentLayout);
    }
    ...
    private void createLoadingLayout() {
        ...
        if (!TextUtils.isEmpty(loadingText)) {
            TextView loadingTextView = loadingLayout.findViewById(R.id.loading_content);
    ...
    public void showLoadingLayout() {
        createLoadingLayout();
        loadingLayout.setId(contentLayout.getId());
    ...
    private void createEmptyLayout() {
        ...
        if (!TextUtils.isEmpty(emptyText)) {
            TextView emptyTextView = emptyLayout.findViewById(R.id.empty_content);
        ...
        // 设置默认空数据布局的图片
        ImageView emptyImageView = emptyLayout.findViewById(R.id.empty_image);
    ...
    public void showEmptyLayout() {
        createEmptyLayout();
        emptyLayout.setId(contentLayout.getId());
    ...
    private void createErrorLayout() {
        ...
        if (!TextUtils.isEmpty(errorText)) {
            TextView errorTextView = errorLayout.findViewById(R.id.error_content);
        ...
        // 设置默认出错布局的图片
        ImageView errorImageView = errorLayout.findViewById(R.id.error_image);
    ...
    public void showErrorLayout() {
        createErrorLayout();
        errorLayout.setId(contentLayout.getId());
    ...
    public View showCustomLayout(@LayoutRes int customLayoutID) {
        ...
        customerView.setId(contentLayout.getId());
    ...
    public static final class Builder {
         ...
         * @since v1.0.0
         */
        public Builder setOnStatusChildClickListener(MultipleLayoutChildClickListener listener) {
        ...
        @NonNull
        @CheckResult
        public MultipleLayoutManager build() {
            return new MultipleLayoutManager(this);
        }
