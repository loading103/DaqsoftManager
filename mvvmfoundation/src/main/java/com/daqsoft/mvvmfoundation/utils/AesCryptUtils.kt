...
import com.daqsoft.mvvmfoundation.BuildConfig
...
object AesCryptUtils {
    ...
    private var PASSWORD = BuildConfig.LIBRARY_PACKAGE_NAME
    ...
    fun encrypt(message: String,password: String = PASSWORD): String {
        try {
     ...
     */
    @Throws(GeneralSecurityException::class)
    fun decrypt(base64EncodedCipherText: String,password: String = PASSWORD): String {
