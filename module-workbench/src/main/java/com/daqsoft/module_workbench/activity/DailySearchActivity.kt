 ...
 */
@AndroidEntryPoint
@Route(path = ARouterPath.Workbench.PAGER_DAILY_SEARCH)
class DailySearchActivity : AppBaseActivity<ActivityDailySearchBinding, DailySearchViewModel>() {
    ...
    override fun initViewModel(): DailySearchViewModel? {
        return viewModels<DailySearchViewModel>().value
    }
