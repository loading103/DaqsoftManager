 ...
 */
@AndroidEntryPoint
@Route(path = ARouterPath.Workbench.PAGER_CUSTOMER_RECORD)
class CustomerRecoredActivity : AppBaseActivity<ActivityCustomerRecordBinding, CustomerRecordViewModel>() {
    ...
    val projectDynamicsAdapter : CustomerRecordAdapter by lazy { CustomerRecordAdapter(this) }
    ...
    override fun initViewModel(): CustomerRecordViewModel? {
        return viewModels<CustomerRecordViewModel>().value
    }
                ...
                setOnClickListener(object : InputBottomPopupCustomer.OnClickListener {
                    ...
                    override fun aTail() {
                        ARouter
                            ...
                            .withString("projectId",this@CustomerRecoredActivity.id)
                            .navigation(this@CustomerRecoredActivity,STAFF)
                    }
