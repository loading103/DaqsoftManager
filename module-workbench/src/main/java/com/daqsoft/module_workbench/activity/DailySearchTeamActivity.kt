 ...
 */
@AndroidEntryPoint
@Route(path = ARouterPath.Workbench.PAGER_TEAM_SEARCH)
class DailySearchTeamActivity : AppBaseActivity<ActivityDailyTeamSearchBinding, DailySearchTeamViewModel>() {
    ...
    override fun initContentView(savedInstanceState: Bundle?): Int {
        return R.layout.activity_daily_team_search
    }

    override fun initViewModel(): DailySearchTeamViewModel? {
        return viewModels<DailySearchTeamViewModel>().value
    }
