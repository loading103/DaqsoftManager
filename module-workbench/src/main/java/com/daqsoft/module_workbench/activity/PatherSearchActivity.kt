...
import com.daqsoft.module_workbench.databinding.ActivityPatherSearchBinding
...
@AndroidEntryPoint
@Route(path = ARouterPath.Workbench.PAGER_PATERNER_SEARCH)
class PatherSearchActivity : AppBaseActivity<ActivityPatherSearchBinding, PatherSearchViewModel>() {
    ...
    override fun initContentView(savedInstanceState: Bundle?): Int {
        return R.layout.activity_pather_search
    }

    override fun initViewModel(): PatherSearchViewModel? {
        return viewModels<PatherSearchViewModel>().value
    }
