 ...
 */
class DailyDateTeamChildViewModel :  BaseViewModel<WorkBenchRepository> {
    ...
    val dailyDataBean = MutableLiveData<DailyTeamDataBeans>()

    val dailyDataLiveData = ObservableField<DailyTeamDataBeans>()
    ...
    fun getMonthData(curYear: Int, curMonth: Int) {
        ...
        addSubscribe(
            model.getTeamCalender(month.toString())
                .compose(RxUtils.exceptionTransformer())
                .compose(RxUtils.schedulersTransformer())
                .subscribeWith(object : AppDisposableObserver<AppResponse<DailyTeamDataBeans>>() {
                    override fun onSuccess(t: AppResponse<DailyTeamDataBeans>) {
