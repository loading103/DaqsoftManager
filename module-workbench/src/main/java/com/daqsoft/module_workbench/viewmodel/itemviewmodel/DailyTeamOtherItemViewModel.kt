 ...
 */
class DailyTeamOtherItemViewModel(
    private val dailyListViewModel: DailyTeamOtherViewModel,
    it: DialyRecord
) : MultiItemViewModel<DailyTeamOtherViewModel>(dailyListViewModel){
    ...
    val onSubmitClick = BindingCommand<Unit>(BindingAction {
        dailyListViewModel.setItemViewModel(this@DailyTeamOtherItemViewModel)
        goAddView()
    })
