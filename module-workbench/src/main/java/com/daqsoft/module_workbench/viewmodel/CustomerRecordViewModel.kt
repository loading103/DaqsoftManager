...
class CustomerRecordViewModel : ToolbarViewModel<WorkBenchRepository>,Paging2Utils<ItemViewModel<*>>{
    ...
    var itemBinding: ItemBinding<ItemViewModel<*>> = ItemBinding.of(
        BR.viewModel,
        R.layout.recyclerview_customer_record_item
    )
                        ...
                        .subscribeWith(object :
                            ...
                            override fun onSuccess(t: AppResponse<CustomerRecordBeanPaging>) {
                                t.data?.let {
                                    ...
                                    it.records.forEach {
                                        val itemViewModel = CustomerRecordItemViewModel(this@CustomerRecordViewModel, it)
        ...
        addSubscribe(
            Observable.create(ObservableOnSubscribe<List<MultipartBody.Part>> {
                ...
                .concatMap(Function<AppResponse<List<UploadResult>>, Observable<AppResponse<Any>>> {
                    ...
                    return@Function model.saveCustomerRecord(request)
                })
                .compose(RxUtils.exceptionTransformer())
                .compose(RxUtils.schedulersTransformer())
                .subscribeWith(object : AppDisposableObserver<AppResponse<Any>>() {
                    override fun onSuccess(t: AppResponse<Any>) {
                        ...
                        LiveEventBus.get(LEBKeyGlobal.CUSTOMER_SENT_SUCCESSFULLY).post(true)
