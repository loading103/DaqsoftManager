...
class TagDetailItemViewModel (val customerViewModel: CustomerDetailViewModel, val data: CustomerTagListBean
) : ItemViewModel<CustomerDetailViewModel>(customerViewModel){
