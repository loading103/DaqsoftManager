 ...
 */
@AndroidEntryPoint
@Route(path = ARouterPath.Workbench.PAGER_DAILY_DATA_MINE)
class DailyTeamDateChild1Fragment : AppBaseFragment<ActivityDailyDateMineBinding, DailyDateMineViewModel>(){
    ...
    override fun initContentView(
        ...
        return R.layout.activity_daily_date_mine
    }

    override fun initViewModel(): DailyDateMineViewModel? {
        return ViewModelProvider(this).get(DailyDateMineViewModel::class.java)
    }
