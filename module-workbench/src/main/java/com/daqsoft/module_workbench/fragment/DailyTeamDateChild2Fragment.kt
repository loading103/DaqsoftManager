...
import com.daqsoft.module_workbench.databinding.ActivityDailyDateMineBinding
import com.daqsoft.module_workbench.databinding.ActivityDailyDateTeamBinding
import com.daqsoft.module_workbench.databinding.ActivityDailyDateTeamChildBinding
import com.daqsoft.module_workbench.viewmodel.DailyDateMineViewModel
import com.daqsoft.module_workbench.viewmodel.DailyDateTeamChildViewModel
 ...
 */
@AndroidEntryPoint
@Route(path = ARouterPath.Workbench.PAGER_DAILY_DATA_TEAM_CHILD)
class DailyTeamDateChild2Fragment : AppBaseFragment<ActivityDailyDateTeamChildBinding, DailyDateTeamChildViewModel>(){
    ...
    override fun initContentView(
        ...
        return R.layout.activity_daily_date_team_child
    }

    override fun initViewModel(): DailyDateTeamChildViewModel? {
        return ViewModelProvider(this).get(DailyDateTeamChildViewModel::class.java)
    }
