 ...
 */
@AndroidEntryPoint
@Route(path = ARouterPath.Workbench.PAGER_DAILY_ALL)
class DailyTeamOtherFragment : AppBaseFragment<ActivityDailyTeamOtherBinding, DailyTeamOtherViewModel>() {
    ...
    override fun initContentView(
        ...
        return R.layout.activity_daily_team_other
    }

    override fun initViewModel(): DailyTeamOtherViewModel? {
        return ViewModelProvider(this).get(DailyTeamOtherViewModel::class.java)
    }
     ...
     */
    @Inject
    lateinit var mAdapter : DailyTeamOtherAdapter

    private fun initRecycleView() {
        binding?.recyclerView.apply {
            adapter = mAdapter
            mAdapter.datas=viewModel.datas
