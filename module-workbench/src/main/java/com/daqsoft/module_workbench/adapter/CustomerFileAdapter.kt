...
import com.daqsoft.module_workbench.databinding.RecyclerviewAnnexFileItemCustomerBinding
 ...
 * @describe
 */
class CustomerFileAdapter : BindingRecyclerViewAdapter<String>() {
    ...
    override fun onBindBinding(
        ...
        val itemBinding = binding as RecyclerviewAnnexFileItemCustomerBinding
        val file = File(item)
