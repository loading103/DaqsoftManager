...
import com.daqsoft.module_workbench.databinding.RecyclerviewItemRecordPaterBinding
import com.daqsoft.module_workbench.viewmodel.itemviewmodel.CustomerCzItemViewModel
import com.daqsoft.module_workbench.viewmodel.itemviewmodel.PatherCzItemViewModel
import com.daqsoft.mvvmfoundation.base.ItemViewModel
import me.tatarka.bindingcollectionadapter2.BindingRecyclerViewAdapter
import javax.inject.Inject

class PatherFlowAdapter  @Inject constructor()  : BindingRecyclerViewAdapter<ItemViewModel<*>>() {
    override fun onBindBinding(
        ...
        var item = item as PatherCzItemViewModel
        var itemBinding = binding as RecyclerviewItemRecordPaterBinding
