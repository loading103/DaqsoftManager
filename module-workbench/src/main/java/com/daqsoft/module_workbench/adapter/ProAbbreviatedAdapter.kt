 ...
 * @describe
 */
class ProAbbreviatedAdapter @Inject constructor() : BindingRecyclerViewAdapter<MultiItemViewModel<*>>() {

    var containerViewModel : ProjectDeptDocContainerViewModel? = null
