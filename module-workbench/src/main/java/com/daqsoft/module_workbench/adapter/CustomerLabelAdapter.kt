...
import com.daqsoft.module_workbench.databinding.RecyclerviewInputPopupItemCustomerBinding
 ...
 * @describe
 */
class CustomerLabelAdapter : BindingRecyclerViewAdapter<ProjectLabel>() {
    ...
    override fun onBindViewHolder(
        ...
        val itemBinding = DataBindingUtil.getBinding<ViewDataBinding>(holder.itemView) as RecyclerviewInputPopupItemCustomerBinding
