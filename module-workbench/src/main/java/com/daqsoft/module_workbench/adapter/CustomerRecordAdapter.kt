...
class CustomerRecordAdapter constructor(val activity: AppBaseActivity<*, *>) : BindingRecyclerViewAdapter<ItemViewModel<*>>() {
    ...
    override fun onBindBinding(
        ...
        val itemBinding = binding as RecyclerviewCustomerRecordItemBinding
        val itemViewModel = item as CustomerRecordItemViewModel
...
//        webSettings.loadWithOverviewMode = true
    ...
    inner class ReplyAdapter : BindingRecyclerViewAdapter<CustomerRecordBean>() {
        ...
        var itemClickBinding: RecyclerviewCustomerRecordItemBinding?=null
        var itemClickViewModel: CustomerRecordItemViewModel?=null
        ...
        fun setViewModel(position: Int, itemBinding: RecyclerviewCustomerRecordItemBinding, itemViewModel: CustomerRecordItemViewModel) {
    ...
    fun refreshItem(item: CustomerRecordBean){
        ...
        try {
            clickItem.run {
                ...
                val itemBinding = this["itemBinding"] as RecyclerviewCustomerRecordItemBinding
                val itemViewModel = this["itemViewModel"] as CustomerRecordItemViewModel
